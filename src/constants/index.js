import { people01, people02, people03, facebook, instagram, linkedin, twitter, airbnb, binance, coinbase, dropbox, send, shield, star, skills, interests,experience } from "../assets";
...
export const features = [
  {
    ...
    title: "Skills",
    content:
      "All the skills like languages , technologies and everythong can be written point wise and can be shown in different way.",
  },
  {
    id: "Interests",
    icon: interests,
